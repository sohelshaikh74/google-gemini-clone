      ...
      <div className="main-container">
        {!showResult ? (
          ...
          <div className="result">
            <div className="result-title">
              <img src={assets.user_icon} alt="" />
              <p className="title-text">{recentPrompt}</p>
            </div>
        ...
        <div className="main-bottom">
          <div className="search-box">
            ...
            />
            <div>
              <img className="input-icons" src={assets.gallery_icon} alt="" />
              <img className="input-icons" src={assets.mic_icon} alt="" />
              {input ? (
                <img
